<template>
    <div class="user-container">
        ...
        <div class="order-list">
            <div class="item" v-for="item in orderListData" :key="item.id" @click="detailed(item.order_no)">
                <div class="info">
                    ...
                    <div class="flex-1">
                        ...
                        <span class="status" :class="'color-' + item.order_status">
                            {{ cars_status[item.order_status] ? cars_status[item.order_status].zh : "" }}
                        </span>
                    </div>
                </div>
...
export default {
    ...
    data(){
        return {
            ...
            page_number: 1,
            // 车辆状态
            cars_status: this.$store.state.config.cars_status
        }
        
    },
    methods: {
        orderList(){
            OrderList({pageNumber:1,pageSize:10}).then(response=>{
